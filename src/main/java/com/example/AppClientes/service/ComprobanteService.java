...
import com.example.AppClientes.entity.*;
import com.example.AppClientes.repository.ClienteRepository;
import com.example.AppClientes.repository.ComprobanteRepository;
...
public class ComprobanteService {
    ...
    private Comprobante armarComprobante(Comprobante comprobante) {
        ...
        Hora worldClock = this.restTemplate.getForObject("http://worldclockapi.com/api/json/utc/now", Hora.class);
